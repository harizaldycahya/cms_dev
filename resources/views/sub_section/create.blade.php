        ...
        <div class="card-body px-5 py-5">
            <div class="row align-items-center">
                <div class="col-9">
                    ...
                    <h3 class="fw-semibold text-white" style="font-size: 1.8rem;"> CREATE SUB SECTION </h3>
...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('sub_section.store') }}" method="POST" enctype=multipart/form-data>
                        {{ csrf_field() }}
                                ...
                                <tbody id="tableToModify">
                                    <tr id="rowToClone" class="testing2">
                                        ...
                                        <td style="min-width:20rem;">
                                            <input  class="form-control" class="outline outline-2" name="sub_section_name[]" type="text">
                                        </td>
                                        ...
                                        <td ><input class="form-control" class="outline outline-2" name="type_id[]" type="text" value=""></td>
                                        <td style="min-width:3rem;"><input type="text" name="sub_site_owner_near_end[]" class="sub_site_owner_near_end form-control mb-2"></td>
                                        <td style="min-width:3rem;"><input type="text" name="sub_site_owner_far_end[]" class="sub_site_owner_far_end form-control mb-2"></td>
                                        <td style="min-width:3rem;"><input type="number" step="0.0001" min="0" name="sub_initial_length[]" class="sub_initial_length form-control mb-2" value=""></td>
                                        <td style="min-width:3rem;"><input type="number" step="0.0001" min="0" name="sub_initial_min_total_loss[]" class="sub_initial_min_total_loss form-control mb-2" value=""></td>
                                        <td style="min-width:3rem;"><input type="number" step="0.0001" min="0" name="sub_initial_max_total_loss[]" class="sub_initial_max_total_loss form-control mb-2" value=""></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
