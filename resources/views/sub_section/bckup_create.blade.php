                            ...
                            <table class="table table-bordered text-nowrap mb-0 align-middle" style="margin-top:1rem;">
                                ...
                                <tbody id="tableToModify">
                                    <tr id="rowToClone" class="testing2">
                                        ...
                                        <td >
                                            <input class="form-control" class="outline outline-2" name="section_type[]"
                                            type="text">
                                        </td>
                                        <td>
...
@section('script')
    <script>
        ...
        function cloneRow() {
            ...
            var lastSectionIdInput = lastRow.querySelector('input[name="sub_section_id[]"]');
            var newSectionIdInput = clone.querySelector('input[name="sub_section_id[]"]');
