    ...
    <div class="card bg-dark text-white shadow-lg position-relative overflow-hidden">
        <div class="card-body px-5 py-5">
            <div class="row align-items-center">
                <div class="col-9">
                    <h3 class="fw-semibold text-white" style="font-size: 1.5rem;"> Master Data Customer</h3>
        ...
        <div class="col-lg-12 align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-6">
                            <h5 class="card-title fw-semibold mb-4 text-start">Customer Lists</h5>
                        </div>
                        <div class="col-6 text-end">
                            <a href="{{route('customer.create')}}" class="btn btn-primary" type="button">
                                Create New Customer
                            </a>
                        </div>
                    </div>
                            ...
                            <thead class="bg-dark fs-4">
                                    <tr>
                                        <th style="width:10%;" class="text-center">
                                            <h6 style="color:white; display:inline-block;" class="fw-semibold mb-0">Customer ID</h6>
                                        </th>
                                        <th style="width:80%;">
                                            <h6 style="color:white; display:inline-block;" class="fw-semibold mb-0 px-4">Customer Name</h6>
                                        </th>
                                        <th style="width:10%;">
                            ...
                            <tbody>
                                @php
                                    $customers = DB::table('customer')
                                        ->where('customer_id', '!=', '000') // Exclude customer_id '000'
                                        ->orderByRaw('CAST(customer_id AS UNSIGNED) ASC')
                                        ->get();
                                @endphp
                                @foreach ($customers as $customer)
                                    <tr>
                                        <td style="width:10%; text-align: center;">{{$customer->customer_id}}</td>
                                        ...
                                        <td style="width:20%; text-align: center;">
                                            <a href="{{ route('customer.edit', ['customer_id' => $customer->customer_id]) }}" class="btn btn-secondary">
                                                <i style="font-size:1.3rem;" class="ti ti-pencil"></i>
                                            </a>
                                            <a href="{{ route('customer.delete', ['customer_id' => $customer->customer_id]) }}" class="btn btn-danger">
