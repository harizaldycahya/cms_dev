...
class SectionController extends Controller
{
    ...
    public function show($project_id, $segment_id, $section_id)
    {        
    ...
    public function create($project_id, $segment_id)
    {
        return view('section.create')->with('project_id', $project_id)->with('segment_id', $segment_id);
    }
            ...
            case 'with_sub_section':
                   ...
                   for($i= 0; $i < $loop_section; $i++){
                        ...
                        DB::table('section')->insertGetId([
                            ...
                            'cable_category' => $request->head_sub_cable_category[$i],
                            ...
                            for($x = 0; $x < $loop_ropa_sub_section; $x++){
                                $randomString = generateRandomString(20);
                                    DB::table('sub_section')->insert([
                                        ...
                                        'sub_owner' => $request->ropa_sub_owner[$request->card_id[$i]][$x],
                        ...
                        if (!is_null($request->sub_section_name)) {
                            ...
                            for($x = 0; $x < $loop_sub_section; $x++){
                                ...
                                DB::table('sub_section')->insert([
                                    ...
                                    'sub_owner' => $request->sub_owner[$request->card_id[$i]][$x],
                    ...
                    return redirect()->route('segment.show', ['project_id'=>$request->project_id, 'segment_id'=>$request->segment_id]);
                break;
            default:
    ...
    public function edit($project_id, $segment_id, $section_id)
    {
    ...
    public function delete($project_id, $segment_id, $section_id){
        DB::table('section')->where('section_id', $section_id)->delete();
        DB::table('sub_section')->where('section_id', $section_id)->delete();
        DB::table('core')->where('section_id', $section_id)->delete();
        DB::table('draf_sor')->where('section_id', $section_id)->delete();
        return redirect()->route('segment.show', ['project_id'=>$project_id, 'segment_id'=>$segment_id])->with('success', 'Data is successfully deleted !');
