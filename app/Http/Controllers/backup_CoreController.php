    ...
    public function store_upload_excel(Request $request){
        ...
        if($file = $request->file('file')) {
            ...
            if(isset($request->sub_section_id)){
                ...
                $app_path = storage_path('app/public/excel/'.$project_id.'/'.$segment_id.'/'.$section_id.'/'.$sub_section_id);

                DB::table('core')->where('sub_section_id', $section_id)->delete();
                ...
                $spreadsheet = IOFactory::load(storage_path('app/public/excel/'.$project_id.'/'.$segment_id.'/'.$section_id.'/'.$sub_section_id.'/'.$file_upload));
                ...
                foreach ( $row_range as $row ) {
                    ...
                    $end_cable = $sheet->getCell( 'C' . $row )->getValue();
                    $total_loss_db = $sheet->getCell( 'D' . $row )->getValue();
                    $loss_db_km = $sheet->getCell( 'E' . $row )->getValue();
                ...
                $section = DB::table('section')->where('section_id', $section_id)->first();
                $length = $section->initial_length;
                $min_total_loss = $section->initial_min_total_loss;
                $max_total_loss = $section->initial_max_total_loss;
